    ...
    return <div>
        <div className="fixed w-full">
            <div className="flex justify-between p-4 border-b border-gray-800">
                <div>
                    <h1 className="text-2xl px-20 py-2 font-bold">Home</h1>  
                </div>
                <div className="flex w-2/5 border border-gray-800 focus-within:border-blue-500 transition-all duration-200 h-10 rounded-3xl bg-[#191919] py-1">
