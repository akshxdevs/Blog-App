export const Navbar = () =>  {
    return <div className="">
            <div className="fixed flex flex-col w-20 border-r border-gray-800">
                <div className="p-5"> 
                    <button>
                ...
                <div className="py-32 px-5">
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <div className="px-2 py-3">
                            <button>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-7">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.76c0 1.8 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.076-4.076a1.526 1.526 0 0 1 1.037-.443 48.282 48.282 0 0 0 5.68-.494c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 8.741v6.018Z" />
                                </svg>
                            </button>
                        </div>
                        <div className="px-2 py-3">
